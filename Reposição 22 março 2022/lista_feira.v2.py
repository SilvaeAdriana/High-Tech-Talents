...
# Nessa versão do programa, o item é retirado da lista pelo usuário através da menção direta pelo nome do item
...
while True:
    ...
    if opcao in [1,2,3,4]:
        if opcao == 1: #Cadastrar
            ...
            for item in lista:
                print(item,'')            
        elif opcao == 3: # Retirar
            for item in lista:
                print(lista)
                fora = input("Digite o produto a ser retirado: ")
                lista.remove(fora)
